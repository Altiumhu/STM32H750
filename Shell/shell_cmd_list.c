...
const ShellCommand shellCommandList[] = 
{
    ...
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
					version, AppUser_version, "AppUser_version"),
   //系统复位               
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    reboot, AppUser_sys_reset, "reset!!"),
//    //更新固件
//    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
//    upfw, AppUser_Up_Firmware, "upfw !!"),
   //设置开环和闭环模式              
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    loop, Set_Loop_Mode_EN, "loop"),
		
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    debug, debug_show_en, "debug"),		

    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    init, AppUser_Write_Init_REC_Device, "init"),		
		//启动开机
		SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    start, StartSystme, "start"),		
    ...
    //RS485测试             
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    rs485, test_RS485, "rs485 test "),
    //设置RS485波特率           
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    set485, AppUser_Set_RS485_BandRat, "rs485 0-9600 1-57600 2-115200 "),
     //adc测试             
    //RS485测试             
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    at24c02, AppUser_InitAT24C02_CalData, "Initial  data"),
               
    //AppUser_Read_DeviceID           
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    getid, AppUser_Read_DeviceID, "getid ID "),
    //设置温度模块ID
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    setid, AppUser_Set_DeviceID, "getid"),
    
    //设置温度报警值
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    setat, AppUser_Set_AlarmTempture, "Set_AlarmTempture"),  
     //打开温度扫描模式
...
//     //选择PT100和PT1000模式
//    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
//    pt, AppUser_Set_PTSensor, "ptsensor 0 pt100; 1---pt1000 "),
   /**************************************************/
       //测试函数功能
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    test, AppUser_Test_Funtion, "AppUser_Test_Funtion  "),
   /**************************************************/ 
   
       //打开debug
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC)|SHELL_CMD_DISABLE_RETURN,
    debug, AppUser_Opening_the_debugger, "debug 0 close ; 1---open "),
   /**************************************************/ 
