...
//    rcc_osc_init_handle.PLL.PLLFRACN = 0;
  ...
  rcc_osc_init_handle.PLL.PLLM = 2;
  rcc_osc_init_handle.PLL.PLLN = 44;
  rcc_osc_init_handle.PLL.PLLP = 1;
  rcc_osc_init_handle.PLL.PLLQ = 5;
  rcc_osc_init_handle.PLL.PLLR = 2;

  rcc_osc_init_handle.PLL.PLLRGE = RCC_PLL1VCIRANGE_3;
  rcc_osc_init_handle.PLL.PLLVCOSEL = RCC_PLL1VCOWIDE;
  rcc_osc_init_handle.PLL.PLLFRACN = 0;
