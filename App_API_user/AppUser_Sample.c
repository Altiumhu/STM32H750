...
uint32_t g_SanSampTimer =1000;
uint32_t g_samptimer = 800; // 增加延时，让CD4052切换后充分稳定
/*=================================================================================================
 * 全局变量定义
 *================================================================================================*/
...
void GetADC_Driver_Result(void)
{
    ...
    case 0:
        ...
        if (delayTimer >= g_samptimer) // 延时一个开关周期 等待CD4052开关稳定
        {
           ...
           /// SetCD4052(CD4052_Chnum); // 延时够了再切换
            ...
            g_Channelinfo[12].voltage = g_Channelinfo[12].voltage_ADC * 0.050354772f * 2.2f;
            ...
            /* 通道1电流: 采样电阻1.66666mΩ,y = 0.3876x + 796.28 放大倍数 0.3855x + 796.49*/
            if (g_Channelinfo[0].workMode == POWER_RUN_DISCHARGE)
            {
                g_Channelinfo[0].current = g_Channelinfo[0].current_DC_ADC * 0.3855f+ 796.49f;
                g_Channelinfo[4].current = g_Channelinfo[4].current_DC_ADC *  0.3855f+ 796.49f;
                g_Channelinfo[8].current = g_Channelinfo[8].current_DC_ADC *   0.3855f+ 796.49f;
                g_Channelinfo[12].current = g_Channelinfo[12].current_DC_ADC *   0.3855f+ 796.49f;
            }
            else
            {
                g_Channelinfo[0].current = g_Channelinfo[0].current_ADC *  0.3855f+ 796.49f;
                g_Channelinfo[4].current = g_Channelinfo[4].current_ADC *  0.3855f+ 796.49f;
                g_Channelinfo[8].current = g_Channelinfo[8].current_ADC *  0.3855f+ 796.49f;
                g_Channelinfo[12].current = g_Channelinfo[12].current_ADC *   0.3855f+ 796.49f;
            }
    ...
    case 1:
        ...
        if (delayTimer >= g_samptimer) // 延时一个开关周期 等待CD4052开关稳定
        {
            ...
            if (g_Channelinfo[0].workMode == POWER_RUN_DISCHARGE)
            {
                g_Channelinfo[1].current = g_Channelinfo[1].current_DC_ADC * 0.3855f+ 796.49f;
                g_Channelinfo[5].current = g_Channelinfo[5].current_DC_ADC  *0.3855f+ 796.49f;
                g_Channelinfo[9].current = g_Channelinfo[9].current_DC_ADC  *0.3855f+ 796.49f;
                g_Channelinfo[13].current = g_Channelinfo[13].current_DC_ADC * 0.3855f+ 796.49f;
            }
            else
            {
                g_Channelinfo[1].current = g_Channelinfo[1].current_ADC *0.3876f+ 796.28f;
                g_Channelinfo[5].current = g_Channelinfo[5].current_ADC  *0.3855f+ 796.49f;
                g_Channelinfo[9].current = g_Channelinfo[9].current_ADC  *0.3855f+ 796.49f;
                g_Channelinfo[13].current = g_Channelinfo[13].current_ADC *0.3876f+ 796.28f;
            }
