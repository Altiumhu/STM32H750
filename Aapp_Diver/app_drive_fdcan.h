...
#define FDCAN3_RX_GPIO_PORT                GPIOA
#define FDCAN3_RX_GPIO_PIN                 GPIO_PIN_11
#define FDCAN3_RX_GPIO_AF                  GPIO_AF9_FDCAN1
#define FDCAN3_RX_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)              /* PA口时钟使能 */

#define FDCAN3_TX_GPIO_PORT                GPIOA
#define FDCAN3_TX_GPIO_PIN                 GPIO_PIN_12
#define FDCAN3_TX_GPIO_AF                  GPIO_AF9_FDCAN1
#define FDCAN3_TX_GPIO_CLK_ENABLE()        do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)              /* PA口时钟使能 */

/* FDCAN1接收RX0中断使能 */
#define FDCAN3_RX0_INT_ENABLE   0         /* 0,不使能;1,使能. */
